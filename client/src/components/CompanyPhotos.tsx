                     ...
                     <div className="hidden md:flex gap-2">
                        {categories.map(cat => (
                           <button
                              ...
                              className={`px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all ${filter === cat
                        ...
                        <AnimatePresence mode='popLayout'>
                           {filteredImages.map((img) => (
                              <motion.div
                                 ...
                                 className={`relative group rounded-xl overflow-hidden border border-slate-800 bg-slate-900 ${img.size === 'wide' ? 'md:col-span-2' : ''
                                    }`}
                              >
