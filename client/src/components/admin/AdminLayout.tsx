...
import { LayoutDashboard, Users, Briefcase, LogOut, Shield, LineChart, Image as ImageIcon } from 'lucide-react';
    ...
    <div className="flex h-screen bg-midnight text-slate-200">
      ...
      <aside className="w-64 bg-slate-900 border-r border-slate-800 p-6 flex flex-col">
        ...
        <nav className="flex-1 space-y-2">
          ...
          <Link to="/admin/photos" className="flex items-center gap-3 px-4 py-3 rounded hover:bg-slate-800 text-slate-400 hover:text-white transition-colors">
