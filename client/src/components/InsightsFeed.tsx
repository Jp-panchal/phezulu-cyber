      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
          ...
          <Link 
            ...
            className="text-crimson hover:text-white transition-colors text-sm font-medium flex items-center gap-1"
          >
          ...
          {insights.map((item, idx) => (
            ...
            >
              <motion.div
                ...
                className="group block p-6 rounded-xl border border-slate-800 bg-slate-900/40 hover:bg-slate-800/60 transition-colors h-full"
              >
