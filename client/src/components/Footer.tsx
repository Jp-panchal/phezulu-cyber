      ...
      <div className="container mx-auto px-6 mb-20">
        <div className="rounded-3xl bg-gradient-to-r from-crimson to-rose-700 p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl shadow-crimson/20">
          ...
          <div className="shrink-0">
            <Button
              onClick={openContact}
              className="bg-white !text-rose-900 hover:bg-rose-50 hover:text-rose-950 shadow-none whitespace-nowrap !opacity-100 !visible"
            >
              <span className="!opacity-100 !visible">Start Your Audit</span>
            </Button>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-4 gap-12 border-b border-slate-800 pb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li className="pt-4">
                <span className="block font-bold text-white text-xs uppercase tracking-wider mb-1">Global HQ</span>
                101 Cyber City Blvd, Tech District<br />
                Cape Town, South Africa
              </li>
              <li className="pt-2">
                <span className="block font-bold text-white text-xs uppercase tracking-wider mb-1">India Office</span>
                Hayat 104, Cyber World, GIT<br />
                Rajasthan, India
              </li>
              <li className="pt-2">
