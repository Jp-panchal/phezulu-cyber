        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center relative">
          ...
          >
            ...
            <p className="text-slate-400 text-lg mb-8 leading-relaxed">
              In an era where "secure" is a moving target, Phezulu redefines the perimeter. We presume breach—not as a fatalist admission, but as a strategic advantage. This philosophy drives us to architect resilience into every layer of your infrastructure, ensuring that when defenses are tested, your operations remain antifragile.
            </p>

            <p className="text-slate-400 text-base mb-8 leading-relaxed">
              We introduce <span className="text-white font-semibold">Cognitive Comfort</span>: the peace of mind that comes from knowing your security posture is proactive, not reactive. By fusing military-grade threat intelligence with human-centric design, we filter the chaos of constant alerts into clear, actionable signals. We don't just protect your data; we protect your focus, allowing you to innovate without the paralysis of fear.
            </p>
