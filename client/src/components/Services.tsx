...
import { ShieldAlert, Lock, FileCheck, Search, Server, Activity, X, ArrowRight, ChevronRight, Minimize2, ArrowLeft, CheckCircle2, Zap, BarChart3, Image as ImageIcon, Filter } from 'lucide-react';
...
const ServiceModuleCard: React.FC<ServiceModuleCardProps> = ({ 
  ...
  return (
    <motion.div 
      ...
      className={`bg-slate-900/50 border p-6 rounded-xl hover:border-slate-600 transition-all duration-300 group flex flex-col h-full ${
        isHighlighted ? 'border-crimson/60' : 'border-slate-800'
      }`}
    >
      <div className="mb-4">
        {pillarContext && (
    ...
    <section id="services" className="py-24 relative min-h-[800px]">
      ...
      <AnimatePresence>
        {selectedPillar && (
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-slate-800 bg-midnight/90 backdrop-blur-xl z-20">
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-12 relative">
               ...
               <div className="max-w-6xl mx-auto relative z-10 min-h-full">
                     ...
                     >
                        ...
                        <div className="grid gap-4">
                            ...
                            <div className="grid md:grid-cols-2 gap-6 pb-12">
                              {selectedPillar.details && selectedPillar.details.map((service: ServiceDetail, idx: number) => (
                                <ServiceModuleCard 
                                    key={idx} 
                                    service={service} 
                                    index={idx}
