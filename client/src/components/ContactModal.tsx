      ...
      {isContactOpen && (
        ...
        >
          ...
          >
            ...
            <div className="w-full md:w-2/5 p-8 md:p-12 bg-slate-900/50 border-b md:border-b-0 md:border-r border-slate-800 flex flex-col justify-between overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
              <div>
            ...
            {/* Right Side: Form */}
            <div className="w-full md:w-3/5 p-8 md:p-12 overflow-y-auto bg-midnight relative [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-[130px_1fr] gap-3">
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-900/50 border border-slate-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-crimson transition-colors placeholder:text-slate-600 text-sm"
                  >
