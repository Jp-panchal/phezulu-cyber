...
export const FALLBACK_PILLARS: Pillar[] = [
  {
    ...
    details: [
      ...
      },
      {
        ...
        fullDescription: [
          "MDR-as-a-Service (Managed Detection and Response) is a turnkey security solution where an external team of experts uses advanced analytics to actively hunt for, investigate, andΓÇöcruciallyΓÇörespond to threats across your environment 24/7.",
      ...
      },
      {
        ...
        fullDescription: [
          "XDR-as-a-Service (Extended Detection and Response) is a comprehensive, outsourced security solution that integrates data from all security layersΓÇöendpoints, networks, email, and cloud workloadsΓÇöinto a single, unified view.",
      ...
      },
      {
        ...
        fullDescription: [
          ...
          "Using automated scanning tools, it provides a 'health check' report that highlights specific flawsΓÇösuch as unpatched software or misconfigurationsΓÇöallowing your team to fix these gaps before attackers can exploit them."
        ],
      ...
      },
      {
        ...
        fullDescription: [
          "Dark Web Monitoring is a proactive surveillance service that continuously scans hidden internet forums, marketplaces, and data dump sites for your organizationΓÇÖs stolen credentials, sensitive data, or intellectual property.",
      ...
      },
      {
        ...
        fullDescription: [
          ...
          "It enables organizations to plug critical skill gapsΓÇösuch as fractional executive leadership or niche technical consultingΓÇörapidly and cost-effectively, without the overhead and long-term commitment of hiring full-time employees."
        ],
      ...
      },
      {
        ...
        fullDescription: [
          "DLP-as-a-Service (Data Loss Prevention) is a cloud-based solution that monitors, classifies, and protects sensitive data (like credit card numbers or intellectual property) wherever it livesΓÇöwhether in emails, cloud apps, or on devices.",
      ...
      },
      {
        ...
        fullDescription: [
          ...
          "It extends beyond just fixing the technical issue; it helps you navigate the entire crisisΓÇöhandling legal obligations, public relations messaging, and executive decision-makingΓÇöwhile the technical teams work to stabilize and recover your systems."
        ],
      ...
      },
      {
        ...
        fullDescription: [
          "Strategy and IT Governance (GRC) is a consulting discipline focused on ensuring an organizationΓÇÖs technology investments and long-term plans are fully aligned with its core business objectives.",
...
export const FALLBACK_INSIGHTS: Insight[] = [
  ...
  },
  {
    ...
    content: [
      "As organizations aggressively adopt multi-cloud strategies, the complexity of regulatory compliance explodes. Data sovereigntyΓÇöknowing exactly where your customer data physically residesΓÇöbecomes a moving target when leveraging serverless architectures and global CDNs.",
  ...
  },
  {
    ...
    content: [
      "Theory fails when the alert siren rings. In this recorded session, we conducted a live simulation of a software supply chain compromiseΓÇösimilar to SolarWindsΓÇötargeting a dummy financial services firm.",
  ...
  },
  {
    ...
    content: [
      ...
      "This post discusses the psychological toll of 'always-on' alert fatigue. We argue that cognitive offloadingΓÇöoutsourcing Tier 1 and Tier 2 monitoring to MDR providersΓÇöis not just an operational decision, but a human preservation strategy.",
